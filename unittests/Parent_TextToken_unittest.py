...
class ParentTextToken(unittest.TestCase):
    def test_find_your_parent(self):
        xml_filename = open("/Users/ellibleeker/PycharmProjects/prioritised_xml_collation/input_xml/witA-s021-simple.xml")
        ...
        expected = [('Hoe', 's'),('zoet','s'), ('moet','s'), ('nochtans','s'), ('zijn','s'), ('dit','s'), ('werven','del'), ('om','del'), ('trachten','add'), ('naar','add'), ('een','s'), ('vrouw', 's'), ('de','s'), ('ongewisheid','s'), ('vóór','s'), ('de','s'), ('liefelijke','s'), ('toestemming','s'), ('!', 's')]
